...
async function replyImage(sock, msg, imageUrl, caption) {
  try {
...
🔮 *CEK-CEKAN*
┣ .cektt / .cekganteng / .cekcantik
┣ .ceksaldo / .cekjodoh [nama]
┣ .cekiq / .ceknasib / .cekhoki
┗ .cekboty

_Prefix: ${global.prefix} | Have fun! 🎉_`;

  await replyImage(sock, msg, global.menuImage, teksmenu);
}
...
async function handleMessage(sock, msg) {
  try {
    ...
    switch (command) {
      ...
      case "cektt":      await handleCekTT(sock, msg, jid, sender); break;
      case "cekganteng": await handleCekGanteng(sock, msg, jid, sender); break;
      case "cekcantik":  await handleCekCantik(sock, msg, jid, sender); break;
      ...
      case "cekhoki":    await handleCekHoki(sock, msg, jid, sender); break;
